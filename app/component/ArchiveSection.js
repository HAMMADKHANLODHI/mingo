...
const ArchieveSection = ({ classname = "" }) => {
  return (
    <div className={`${classname} flex maincolr flex-col items-center`}>
      <div className='w-full h-[10%] flex justify-between'>
        <div className='w-[30%] text-4xl h-full flex justify-center items-center text-white '><h1>Archived</h1></div>
        
      </div>
      <input type='text ' className='w-[90%] h-[5%] placeholder:text-lg placeholder:text-gray-500  bg-gray-600 rounded-xl mt-[2%]' placeholder="   Search Archived Chat"></input>
...
export default ArchieveSection;
